        ...
        <div class="d-flex justify-content-between">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item">Equipment Class List</li>
            </ol>
          </nav>
          <div></div>
          <div>
            <router-link :to="{name:'EquipmentClassPage',params:{id: null}}" class="icon">
              <button type="button" class="btn btn-primary">New Equipment Class</button>
            </router-link>
          </div>
        </div>
      </div>
          ...
          <table class="table">
            ...
            <tbody>
              <tr v-for="equipment in sortedEquipments" v-bind:key="equipment.id">
                ...
                <td>
                  <router-link :to="{name:'tabEquipments',params:{eq: equipment.eq}}" class="icon">
                  ...
                  <router-link
                    :to="{name:'EquipmentClassPage',params:{id: equipment.id}}"
                    class="icon"
                  >
