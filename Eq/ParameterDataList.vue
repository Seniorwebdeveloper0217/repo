    ...
    <div class="card mt-5">
      <div class="card-header">
        <div class="d-flex justify-content-between">
          ...
          <div></div>
          <div>
            <router-link :to="{name:'ParameterPage',params:{id: null}}" class="icon">
            ...
            <tbody>
              <tr v-for="parameter in parameters" v-bind:key="parameter.id">
                ...
                <td>
                  ...
                  <router-link :to="{name:'ParameterDataPage',params:{id: parameter.id}}" class="icon">
  ...
  methods: {
    async getParameterDatas() {
      let parametersArray = [];
        ...
        parametersArray = await api.getParameterDatas();
    ...
    async onDelete(id) {
      if (confirm("Are you sure you want to delete this Product Parameter?")) {
        this.loaded = false;
        await api.deleteParameterDatas(id);
        await this.getParameterDatas();
        this.loaded = true;
      }
    }
  }
